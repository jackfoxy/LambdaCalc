...
c0 = bottom;
nil = bottom;
c1 = lambda b. lambda z. b z;
c2 = lambda b. lambda z. b (b z);
c3 = lambda b. lambda z. b (b (b z));
c4 = lambda b. lambda z. b (b (b (b z)));
c6 = lambda b. lambda z. b (b (b (b (b (b z)))));

c24 = lambda b. lambda z. b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b (b z)))))))))))))))))))))));
...
fst = lambda p. p tru;
snd = lambda p. p fls;
plus = lambda m. lambda n. lambda b. lambda z. m b (n b z);
